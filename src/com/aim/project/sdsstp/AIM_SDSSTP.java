...
//        System.out.println("runTime = " + runTime);
        if (getBestSolution() == null) {
            ...
            System.out.println("Initial = " + bestSolution.getObjectiveFunctionValue() + ", route = "
                    + Arrays.toString(bestSolution.getSolutionRepresentation().getSolutionRepresentation()));

        } else if (getSolution(index).getObjectiveFunctionValue() < getBestSolutionValue()) {
            bestSolution = getSolution(index).clone();
//            updateTime++;
//            System.out.println("updateTime = " + updateTime);
//            System.out.println("New Best = " + bestSolution.getObjectiveFunctionValue() + ", route = "
//                    + Arrays.toString(bestSolution.getSolutionRepresentation().getSolutionRepresentation()));
        }
    }
...
//        HyperHeuristic hh = new RL_HH(seed);

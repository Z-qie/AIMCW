...
//        long seed = 527893l;
        ...
        System.out.println("f(s_best) hh = " + hh.getBestSolutionValue() + "\nf(s_best) problem = "
                + Arrays.toString(problem.getBestSolution().getSolutionRepresentation().getSolutionRepresentation()) +  " = " + problem.getBestSolution().getObjectiveFunctionValue());
